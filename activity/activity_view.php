...
<body class="activity"> <!-- Class 폴더 -->
	...
	<main id="content">
        ...
        <div class="page-header">
            ...
            <div class="container">
                <h3 class="page-title">CARP 활동게시판</h3>
            </div>
        </div>
        <article class="activity-view">
            <div class="container">
                <div class="board-view">
                    ...
                    <div class="btn-area">
                        <p>
                            <a href="/activity/activity_write.php" class="btn btn-xs btn-org" role="button">글쓰기</a>
                            <a href="#" class="btn btn-xs btn-gray" role="button">수정하기</a>
                            <a href="#" class="btn btn-xs btn-gray" role="button">삭제하기</a>
                        </p>
                        <p>
                            <a href="/activity/activity_list.php" class="btn btn-lg btn-aqua" role="button">목록</a>
                        </p>
                    </div>
