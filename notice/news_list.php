	...
	<main id="content">
        ...
        <article class="news-list">
            <div class="container">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>10</td>
                                <td>제작문의</td>
                                <td class="subject"><a href="/notice/news_view.php">CARP특공대! 세상으로 총 진군하자! CARP특공대! 세상으로 총 진군하자!</a></td>
                                <td>관리자</td>
                                <td>2017-08-05</td>
                                <td>27</td>
                            </tr>
                            <tr>
                                <td>09</td>
                                <td>제작문의</td>
                                <td class="subject"><a href="/notice/news_view.php">CARP특공대! 세상으로 총 진군하자!</a></td>
                                <td>관리자</td>
                                <td>2017-08-05</td>
                                <td>27</td>
                            </tr>
                ...
                <div class="btn-area">
                    <p>
                        <a href="/notice/news_write.php" class="btn btn-lg btn-aqua" role="button">글쓰기</a>
                    </p>
                </div>
