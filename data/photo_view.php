            ...
            <div class="container">
                <div class="board-view">
                    ...
                    <div class="view-content">
                        <p>
                            <img src="/assets/images/data/photo_view_img.jpg" class="img-responsive" alt="">
                        </p>
                    </div>
                    <dl class="attach">
                    ...
                    <div class="btn-area">
                        <p>
                            <a href="/data/photo_write.php" class="btn btn-xs btn-org" role="button">글쓰기</a>
                            <a href="#" class="btn btn-xs btn-gray" role="button">수정하기</a>
                            <a href="#" class="btn btn-xs btn-gray" role="button">삭제하기</a>
                        </p>
                        <p>
                            <a href="/data/photo_list.php" class="btn btn-lg btn-aqua" role="button">목록</a>
                        </p>
                    </div>
